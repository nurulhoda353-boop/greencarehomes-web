...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Green Care Homes" },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "en_BD" },
      { name: "twitter:card", content: "summary_large_image" },
      { title: "Green Care Homes — Compassionate Home Healthcare in Bangladesh" },
      { property: "og:title", content: "Green Care Homes — Compassionate Home Healthcare in Bangladesh" },
      { name: "twitter:title", content: "Green Care Homes — Compassionate Home Healthcare in Bangladesh" },
